...
CMFCstudentDlg::CMFCstudentDlg(CWnd* pParent /*=nullptr*/)
...
BEGIN_MESSAGE_MAP(CMFCstudentDlg, CDialogEx)
	...
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDC_BUTTON1, &CMFCstudentDlg::OnBnClickedButton1)
END_MESSAGE_MAP()
...
void CMFCstudentDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
void CMFCstudentDlg::OnBnClickedButton1()
{
	start start1;
	start1.DoModal();
	// TODO: 在此添加控件通知处理程序代码
